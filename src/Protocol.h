...
constexpr std::size_t kClipboardInlineMaxSize = 1024 * 1024;
constexpr std::size_t kClipboardSocketMaxSize = 8 * 1024 * 1024;
...
constexpr const char* kClipboardSocketTextLabel = "text";
constexpr const char* kClipboardSocketImageLabel = "image";
