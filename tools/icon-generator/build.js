...
const squareLogo = D.wrap(`${D.gradientDefs}
  <rect width="1024" height="1024" fill="url(#bg)"/>${D.donkeyColor}${D.cursor}`);
...
(async () => {
  ...
  const fgSvg = `<svg width="108" height="108" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(0,34)">${D.donkeyColor}</g></svg>`;
  ...
  const monoSvg = `<svg width="108" height="108" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(0,34)">${D.donkeySilhouette('#000000')}</g></svg>`;
  ...
  write(path.join(res, 'drawable', 'ic_inputflow.xml'),
    await toVD(`<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">${D.donkeyColor}</svg>`,
      { floatPrecision: 2 }));
